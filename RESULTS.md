...
| 2 | `modernbert-base-pretrained` | frozen probe | `answerdotai/ModernBERT-base` | 0.8927 | 0.9026 | 0.8631 | **0.8824** |
| 3 | `ettin-150m-pretrained` | frozen probe | `jhu-clsp/ettin-encoder-150m` | 0.8877 | 0.8886 | 0.8681 | **0.8782** |
| 4 | `bert-base-pretrained` | frozen probe | `google-bert/bert-base-uncased` | 0.8596 | 0.8820 | 0.8071 | **0.8429** |
...
|---|---:|---|---:|---:|
| BERT (Finetuned) | 0.9160 | `bert-base-ft` | — | — |
| ModernBERT (Finetuned) | 0.9100 | `modernbert-base-ft` | — | — |
| RoBERTa / AFaCTA (Finetuned) | 0.9040 | `roberta-base-ft` | — | — |
